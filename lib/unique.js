// // module.exports
// const unique = (compressString) => {
//   // function compress(compressString) {
//   if (typeof compressString !== 'string') {
//     return undefined;
//   }
...
//     }
//   }
//   const letter = answer[answer.indexOf(1) - 1];

//   console.log(answer[answer.indexOf(1) - 1]);
//   console.log(answer);
//   return answer[answer.indexOf(1) - 1];
// };
// unique('frof');
